...
<head>
    ...
    <link href="<?php echo e(asset('back/select/css/bootstrap-select.min.css')); ?>" rel="stylesheet">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a href="<?php echo e(url('/create-peminjam')); ?>"><button type="submit" class="w-100 btn btn-primary border-radius">Masuk</button></a>
                        <p class="mt-2 text-center">Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar sekarang!</a></p>
                    </form>
                </div>
            </div>
        </div>
    ...
    <!-- <?php echo $__env->yieldPushContent('scriptes'); ?> -->
    <script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('back/select/js/bootstrap-select.min.js')); ?>"></script>
    ...
    <?php echo $__env->yieldPushContent('peta'); ?>
    <script src="//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.js"></script>

</body>


</html><?php /**PATH E:\Documents\Pallaka Studio\saloi-kumkm\resources\views/layouts/main.blade.php ENDPATH**/ ?>