  ...
  <div class="card bg-dark text-white ">
      <img src="{{ asset('storage/'.$item->gambar_sampul) }}" class="card-img" alt="..." style="filter: brightness(20%); height:600px; object-fit: cover;object-position: top;">
      <div class="card-img-overlay container d-flex align-items-end">
          <div class="row col-md-12 mt-5 py-5 d-flex justify-content-between">
              <div class="col-md-7 col-sm-10">
                  <button class="btn btn-primary fw-bold border-radius px-5">{{ $item->kategori->nama_kategori }}</button>
                  <h5 class="card-title fw-bold display-4 m-0">{{ $item->nama_koperasi }} <span class="text-primary fs-5 fw-normal">*Ketua</span> <span class="fs-5 fw-normal">{{ $item->users->name }}</span></h5>
                  ...
                  <div class="row">
                      ...
                      <p class="fs-5  p-0 col-auto">{{ $item->alamat_koperasi }}</p>
                  </div>
              ...
              <div class="col-md-3 col-sm-12  d-grid align-items-end ">
                  <div class="col-md-5 col-sm-12 d-flex justify-content-center align-items-end ">
                      <a href="{{ route('produkumkm.index') }}"><button class="btn btn-lg btn-light fw-bold border-radius fs-6 py-3  me-2 text-primary"><i class="bi bi-plus-square-fill me-2"></i> Tambah Produk</button></a>
  ...
  <div class="container text-center py-4">
      <ul class="list-inline fs-4 fw-bold opacity-75">
          ...
          <a href="#">
              <li class="list-inline-item text-dark">| Uuuuuuuuuuulasan |</li>
          </a>
      </ul>
  </div>
  {{-- end --}}
  ...
  <div class="container my-5 ">
      <div class="row g-5">
          <div class="col-md-8 col-sm-12 detail-body">
              ...
              <div class="fs-5" style="min-height: 300px">
                  <p>{{ $item->detail_koperasi }}</p>
              </div>
              <p class="bg-primary text-light fw-bold px-4 py-2 border-radius fs-4">Deskripsi Koperasi</p>
              <div class="fs-5" style="min-height: 300px">
                  <p>{{ $item->deskripsi_koperasi }}</p>
              </div>
              <p class="bg-primary text-light fw-bold px-4 py-2 border-radius fs-4">Struktur Organisasi</p>
              <div class="fs-5 " style="min-height: 300px">
                  <div class="row gx-5">
                      <div class="col-12">
                          <img src="{{ asset('storage/'.$item->gambar_sampul) }}" class="border-radius" alt="struktur organisasi" style="width: 100%;  object-fit: cover; object-position: top;">
                      </div>
                  </div>
              </div>
          ...
          <div class="col-md-4 col-sm-12 text-center">
              <img src="{{ asset('storage/'.$item->gambar_logo) }}" class="border-radius mb-5" alt="..." style="width: 80%;  object-fit: cover; object-position: top;">
              ...
              <div class="card mt-5" style="width: 100%; border-radius:15px">
                  ...
                  <ul class="list-group list-group-flush fw-bold text-start" style="font-size: 12px;">
                      <li class="list-group-item p-1 px-3"><i class="bi bi-geo-alt-fill text-primary fs-6 "></i> {{ $item->alamat_koperasi }}</li>
                      <li class="list-group-item p-1 px-3"><i class="bi bi-telephone-fill text-primary fs-6 "></i> {{ $item->no_telpon }}</li>
                      <li class="list-group-item p-1 px-3 bg-body"><i class="bi bi-envelope-fill text-primary fs-6 "></i> {{ $item->email_usaha }}</li>
                  </ul>
              ...
              <div class="card mt-5" style="width: 100%; border-radius:15px">
                  <div class=" text-center">
                      ...
                      <p class="fs-3 fw-bold text-center m-0 lh-1">{{ $item->users->name }}</p>
                      <p class="text-secondary fw-bold fs-5 opacity-75">Founder</p>
                  </div>
                  <ul class="list-group list-group-flush fw-bold text-start" style="font-size: 12px;">
                      <li class="list-group-item p-1 px-3"><i class="bi bi-telephone-fill text-primary fs-6 "></i> Telpon : {{ $item->users->no_telpon }}</li>
                      <li class="list-group-item p-1 px-3 bg-body"><i class="bi bi-envelope-fill text-primary fs-6 "></i> Email : {{ $item->users->email }}</li>
                  </ul>
              </div>
              ...
              <div class="card mt-5 p-3 text-start" style="width: 100%; border-radius:15px">
                  ...
                  <ul class="list-group list-group-flush fw-bold ">
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Senin</p> <span class="text-end">{{ $item->waktu_senin}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Selasa</p> <span class="text-end">{{ $item->waktu_selasa}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Rabu</p> <span class="text-end">{{ $item->waktu_rabu}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Kamis</p> <span class="text-end">{{ $item->waktu_kamis}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Jum'at</p> <span class="text-end">{{ $item->waktu_jumat}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Sabtu</p> <span class="text-end">{{ $item->waktu_sabtu}}</span>
                      </li>
                      <li class="list-group-item p-1 d-flex justify-content-between lh-1 mt-2">
                          <p class="m-0"> Minggu</p> <span class="text-end">{{ $item->waktu_minggu}}</span>
                      </li>
                  </ul>
              </div>
              <div class="card mt-5 p-3 fw-bold text-start" style="width: 100%; border-radius:15px">
                  ...
                  <div class="m-0 lh-1" style="font-size: 12px">
                      <P class="m-0 d-flex align-items-center"><i class="bi bi-link-45deg fs-3 text-primary"></i>{{ $item->website }}</P>
                      <P class="m-0 d-flex align-items-center"><i class="bi bi-link-45deg fs-3 text-primary"></i>{{ $item->instagram }}</P>
