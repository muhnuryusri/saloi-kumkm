                ...
                <div class="col-md-10 col-md-offset-1 pt-4 pb-5">
					...
					<form class="row g-3 mt-3">
						...
						<div class="">
							...
							<div class="col m-0 text-primary d-flex align-items-center justify-content-center">
								<a href="/detailusaha"><button type="button" class="btn btn-primary btn-lg border-radius fw-bold p-3"> Lihat Detail Usaha</button></a>
							</div>
