            ...
            <div class="card-header bg-white ">
                <div class="row justify-content-center">
                    <div class="row col-lg-10 col-md-11 col-sm-12 p-0">
                        <div class=" m-0 p-0">
                            <p class="fs-2 fw-bold m-0 text-start">Daftar UMKM</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <fieldset>
                            <div class="row g-3 mt-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-credit-card-2-front"></i></span>
                                        <input class="required form-control  @error('nib') is-invalid @enderror" type="text" name="nib" id="nib" value="{{ old('nib') }}">
                                        @error('nib')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-credit-card-2-front"></i></span>
                                        <input class="required form-control  @error('modal_usaha') is-invalid @enderror" type="number" name="modal_usaha" id="modal_usaha" value="{{ old('modal_usaha') }}">
                                        @error('nib')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select @error('omzet_tahunan') is-invalid @enderror" name="omzet_tahunan">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control @error('deskripsi_usaha') is-invalid @enderror" id="deskripsi_usaha" style="height: 200px" name="deskripsi_usaha" value="{{ old('deskripsi_usaha') }}">{{ old('deskripsi_usaha') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="deskripsi_usaha" class="form-label">Jam Buka Usaha<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-6 ">
                                ...
                                <!-- <div class="col-md-6">
                                    <label for="waktu_selasa" class="form-label">Selasa</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="waktu_selasa"><i class="bi bi-clock-fill"></i></span>
                                        <select class="form-select @error('waktu_selasa') is-invalid @enderror" id="waktu_selasa" name="waktu_selasa"  value="{{ old('waktu_selasa') }}">
                                            <option selected>Pilih Jam</option>
                                            <option >07.30 - 15-30</option>
                                            <option >08.30 - 16.00</option>
                        ...
                        <fieldset>
                            <div class="row g-3 mt-3">
                                <div class="col-12">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control @error('deskripsi_produk_jasa') is-invalid @enderror" id="deskripsi_produk_jasa" name="deskripsi_produk_jasa" style="height: 200px" value="{{ old('deskripsi_produk_jasa') }}"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row g-3 mt-3 mb-4">
                                <div class="col-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        ...
                                        <input type="text" class="required form-control @error('email_usaha') is-invalid @enderror" id="email_usaha" name="email_usaha" value="{{ old('email_usaha') }}">
                                        @error('email_usaha')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        ...
                                        <input type="text" class="required form-control @error('tokopedia') is-invalid @enderror" id="tokopedia" name="tokopedia" value="{{ old('tokopedia') }}">
                                        @error('tokopedia')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        ...
                                        <input type="text" class="required form-control @error('lazada') is-invalid @enderror" id="lazada" name="lazada" value="{{ old('lazada') }}">
                                        @error('lazada')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        ...
                                        <input type="text" class="required form-control @error('bukalapak') is-invalid @enderror" id="bukalapak" name="bukalapak" value="{{ old('bukalapak') }}">
                                        @error('bukalapak')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class=" col-md-12 input-group mb-3">
                                        ...
                                        <input type="text" class="required form-control @error('shopee') is-invalid @enderror" id="shopee" name="shopee" value="{{ old('shopee') }}">
                                        @error('shopee')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
