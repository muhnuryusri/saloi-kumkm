        ...
        <div class="card shadow bg-body border-radius border-0">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-md-offset-1 pt-4 pb-5">
                    <form method="POST" action="{{ route('register') }}" class="f1" enctype="multipart/form-data">
                        @csrf
                        <div class="f1-steps">
                                    ...
                                    <div class="row g-3 align-items-end ">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class=" col-md-12 input-group mb-3">
                                                ...
                                                <input type="text" class="required form-control @error('no_ktp') is-invalid @enderror" id="no_ktp" name="no_ktp" value="{{ old('no_ktp') }}">
                                                @error('no_ktp')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class=" col-md-12 input-group mb-3">
                                                ...
                                                <input type="text" class="required form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}">
                                                @error('name')
                                                <div class="invalid-feedback d-block text-start">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class=" col-md-12 input-group mb-3">
                                                ...
                                                <input type="text" class="required form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}">
                                                @error('tempat_lahir')
                                                <div class="invalid-feedback d-block text-start">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-md-3 col-sm-7 row align-items-end">
                                    ...
                                    <div class="mb-1 col-md-12 ">
                                        <p class="image_upload">
                                            ...
                                            <input type="file" name="image" id="profileimage" style="display: none;" class=" @error('image') is-invalid @enderror">
                            ...
                            <div class="my-4">
                                <div class="col-12 my-4">
                                    ...
                                    <div class=" col-md-12 input-group ">
                                        ...
                                        <input type="text" class="required form-control @error('alamat_rumah') is-invalid @enderror" id="alamat_rumah" name="alamat_rumah" value="{{ old('alamat_rumah') }}">
                                        @error('alamat_rumah')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12 my-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select id="country" class="form-control" value="{{ old('province_id') }} " name="province_id">
                                ...
                                <div class="col-md-12 my-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select id="state" name="regency_id" class="form-control">
                                            <option value="{{ old('state') === $list->id ? 'selected' : '' }}" >Pilih Kabupaten/Kota</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 my-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select id="city" name="district_id" class="form-control @error('district_id') is-invalid @enderror">
                                ...
                                <div class="col-md-12 my-4 "><label for="village_id" class="form-label">Kelurahan <span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-building"></i></span>
                                        <select id="village" name="village_id" class="form-control value={{ old('village_id') }}">
                            ...
                            <div class="my-4">
                                <div class="col-12 my-4">
                                    ...
                                    <div class=" col-md-12 input-group">
                                        ...
                                        <input type="email" class="required form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}">
                                        @error('email')
                                        <div class="invalid-feedback d-block text-start">
                                            {{ $message }}
                                        </div>
