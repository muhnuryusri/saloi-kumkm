      ...
      <div class="card-img-overlay container d-flex align-items-end">
          <div class="row col-md-12 mt-5 py-5 d-flex justify-content-between">
              <div class="col-md-7 col-sm-10">
                  ...
                  <h5 class="card-title fw-bold display-4 m-0 overflow-hidden">{{ $umkm->nama_badan_usaha }} <span class="text-primary fs-5 fw-normal">*Founder</span> <span class="fs-5 fw-normal">{{ $umkm->users->name }}</span></h5>
                  ...
                  <div class="row ">
                      ...
                      <p class="fs-5  p-0 col-auto">{{ $umkm->alamat_badan_usaha }}</p>
                  </div>
  ...
  <div class="container text-center p-4 ">
      <ul class="list-inline fs-4 fw-bold m-0 opacity-75">
          <a href="#">
          ...
          <div class="col-md-8 col-sm-12 detail-body">
              ...
              <div class="fs-5 m-5" style="min-height: 300px">
                  <div class="row gx-5">
                      ...
                      <div class="col-4">
                          <img src="{{ asset('storage/'.$item->gambar_produk) }}" class="border-radius" alt="..." style="width: 100%;  object-fit: cover; object-position: top;">
                          <p class="text-center p-1">{{ $item->nama_produk }}</p>
                      </div>
                      @empty
